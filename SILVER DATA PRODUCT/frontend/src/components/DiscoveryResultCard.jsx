...
const LAYER_TINT    = { silver: '#0f766e', bronze: '#8A4A1C' }
const LAYER_BG_TINT = { silver: '#F0FDFA', bronze: '#FBEFE3' }
const LAYER_BORDER  = { silver: '#99F6E4', bronze: '#E5C7A6' }
const LAYERS = ['silver', 'bronze']
