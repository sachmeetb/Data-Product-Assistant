        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <div>
            <div style={{ fontSize: 13, fontWeight: 700, letterSpacing: '0.01em' }}>
              {info.title || 'Silver Layer Data Contract'}
            </div>
            <div style={{ fontSize: 10.5, color: '#E6DCFF', fontFamily: 'monospace' }}>
              {view.id || 'urn:datacontract:banking_silver'}
            </div>
          </div>
        </div>
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              color: activeTab === tab.id ? '#460073' : '#460073',
              border: 'none',
              borderTopLeftRadius: 6,
              borderTopRightLeftRadius: 6,
              padding: '8px 12px',
              fontSize: 11,
        ...
        {activeTab === 'overview' && (
          <div>
            <p style={{ color: '#4b5563', lineHeight: 1.5, marginBottom: 12 }}>
              {info.description || 'BIAN-aligned Silver Layer Data Contract governing schemas and quality expectations.'}
            </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 10, marginBottom: 14 }}>
              ...
              <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: 6, padding: 10 }}>
                ...
                <div style={{ fontWeight: 700, color: '#111827', fontFamily: 'monospace', marginTop: 2 }}>{info.target_dataset || 'banking_silver'}</div>
              </div>
            </div>

            <div style={{ marginTop: 10 }}>
              <div style={{ fontSize: 10.5, fontWeight: 700, color: '#374151', marginBottom: 6, textTransform: 'uppercase' }}>Governance & Regulatory Standards</div>
              <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                {(info.standards || ['BIAN v12', 'ISO 20022', 'FIBO']).map(s => (
                  <span key={s} style={{
                    background: '#E6DCFF',
                    color: '#460073',
                    border: '1px solid #C2A3FF',
        ...
        {activeTab === 'quality' && (
          <div>
            <p style={{ color: '#4b5563', marginBottom: 10 }}>
              Automated data quality assertions attached to this Silver contract:
            </p>
            {quality.length === 0 ? (
